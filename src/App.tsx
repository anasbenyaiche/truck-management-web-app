    ...
    <>
      ...
      <Layout>
        <Routes>
          ...
          <Route
            path="/gestion-camions/enregistrement"
            element={<TruckRegistration />}
          />
          <Route
            path="/gestion-camions/clients"
            element={<ClientManagement />}
          />
          <Route
            path="/gestion-camions/reparations"
            element={<RepairHistory />}
          />

          {/* Gestion des Réparations */}
          <Route
            path="/gestion-reparations/orders"
            element={<RepairOrders />}
          />
          <Route
            path="/gestion-reparations/tracking"
            element={<RepairTracking />}
          />
          <Route
            path="/gestion-reparations/parts"
            element={<PartsAndLabor />}
          />

          {/* Gestion des Pièces Détachées */}
          <Route
            path="/gestion-pieces/catalogue"
            element={<CataloguePieces />}
          />
          <Route path="/gestion-pieces/stocks" element={<StocksTracking />} />
          <Route
            path="/gestion-pieces/approvisionnement"
            element={<SupplyPieces />}
          />
          <Route path="/gestion-pieces/achats" element={<PurchaseHistory />} />

          {/* Facturation et Gestion des Coûts */}
          <Route
            path="/facturation/calcul-couts"
          ...
          <Route
            path="/recherche/multi-criteres"
            element={<MultiCriteriaSearch />}
          />
          <Route path="/recherche/filtres" element={<AdvancedFilters />} />
          <Route
            path="/recherche/historique"
            element={<HistoryAutocompletion />}
          />
        </Routes>
      </Layout>
    </>
